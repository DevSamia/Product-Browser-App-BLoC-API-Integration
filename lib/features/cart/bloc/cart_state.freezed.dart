...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<CartItemModel> cartItems,  double totalPrice)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CartInitial() when initial != null:
return initial();case CartLoading() when loading != null:
return loading();case CartLoaded() when loaded != null:
return loaded(_that.cartItems,_that.totalPrice);case CartError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<CartItemModel> cartItems,  double totalPrice)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case CartInitial():
return initial();case CartLoading():
return loading();case CartLoaded():
return loaded(_that.cartItems,_that.totalPrice);case CartError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<CartItemModel> cartItems,  double totalPrice)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case CartInitial() when initial != null:
return initial();case CartLoading() when loading != null:
return loading();case CartLoaded() when loaded != null:
...
class CartLoaded implements CartState {
  const CartLoaded({required final  List<CartItemModel> cartItems, required this.totalPrice}): _cartItems = cartItems;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartLoaded&&const DeepCollectionEquality().equals(other._cartItems, _cartItems)&&(identical(other.totalPrice, totalPrice) || other.totalPrice == totalPrice));
}
...
@override
String toString() {
  return 'CartState.loaded(cartItems: $cartItems, totalPrice: $totalPrice)';
}
...
@useResult
$Res call({
 List<CartItemModel> cartItems, double totalPrice
});
