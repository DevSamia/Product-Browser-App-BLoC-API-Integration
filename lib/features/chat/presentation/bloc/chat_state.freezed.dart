...
return loaded(_that.messages);case ChatError() when error != null:
...
return loaded(_that.messages);case ChatError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class ChatLoaded implements ChatState {
  const ChatLoaded(final  List<Message> messages): _messages = messages;
