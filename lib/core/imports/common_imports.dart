...
export 'package:product_browser_app/features/chat/data/repositories/firestore_chat_repository.dart';
// Features: Chat (Clean Architecture)
export 'package:product_browser_app/features/chat/domain/entities/message.dart';
export 'package:product_browser_app/features/chat/domain/repositories/chat_repository.dart';
export 'package:product_browser_app/features/chat/domain/usecases/send_message_usecase.dart';
export 'package:product_browser_app/features/chat/domain/usecases/watch_messages_usecase.dart';
export 'package:product_browser_app/features/chat/presentation/bloc/chat_bloc.dart';
export 'package:product_browser_app/features/chat/presentation/bloc/chat_event.dart';
export 'package:product_browser_app/features/chat/presentation/bloc/chat_state.dart';
export 'package:product_browser_app/features/chat/presentation/screens/chat_screen.dart';
export 'package:product_browser_app/features/chat/presentation/widgets/message_bubble.dart';
// Features: Product
